...
Esistono quasi una dozzina di diversi androgeni, ma quelli che ci interessano maggiormente sono il [testosterone](https://it.wikipedia.org/wiki/Testosterone) e il [diidrotestosterone](https://it.wikipedia.org/wiki/Diidrotestosterone).
...
I mineralocorticoidi non hanno nessun ruolo all'interno del percorso di transizione, ma vale la pena menzionarli per parlare di un ormone importante: l'[aldosterone](https://it.wikipedia.org/wiki/Aldosterone).
