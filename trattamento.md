...
siblings:
  ...
  next: /it/causes
  nextCaption: Cause della Disforia di Genere
classes:
  - gdb
---
...
Le opzioni di trattamento variano in maniera significativa in base ai bisogni individuali. Ogni singola transizione è unica, non c'è un modo unico per procedere. In questo capitolo presento la lista dei possibili percorsi.

### Transizione Sociale

Ovvero: fare coming out. L'atto di annunciare al mondo che sei transgender e il nuovo nome e/o pronomi che desideri vengano usati per riferirsi a te – o no; potresti anche voler solo dire alla gente che sei trans e non ti identifichi con il genere assegnato alla tua nascita. Per alcune persone non binarie questo potrebbe non essere un totale allontanamento dal proprio genere assegnato, poiché quest'ultimo è uno spettro ed esistono identità come "uomo non binario" e "donna non binaria".

La transizione sociale è l'atto di uscire allo scoperto, e può alleviare molto stress di chi la compie.

### Transizione Legale

Questa è la procedura per cambiare i propri documenti legali in modo che riflettano il tuo vero genere. Questo potrebbe avvenire con un cambiamento di nome e genere per istanza di tribunale, attraverso un diverso indicatore di genere sui documenti di identità, o ricevendo una nuova versione del proprio certificato di nascita o dei documenti matrimoniali.

### Transizione di Presentazione
...
- Mascolinizzanti:
  ...
  - Isterectomia (rimozione dell'utero e della cervice)
  - Ovariectomia (rimozione di una o di entrambe le ovaie)
  - Salpingectomia (rimozione di una o di entrambe le tube di Falloppio, spesso effettuata assieme all'isterectomia e/o all'ovariectomia)
  - Vaginectomia (rimozione della cavità vaginale)
  - Metoidioplastica (un processo che trasforma il clitoride ingrandito dalla terapia ormonale in un pene)
  - Falloplastica (costruzione di un pene tramite un prelievo di pelle)
  - Uretroplastica (estensione del canale dell'uretra attraverso il fallo)
  - Scrotoplastica (utilizza il labbro maggiore e dei testicoli prostetici per costruire uno scroto).

La falloplastica non richiede necessariamente una precedente terapia ormonale. Per quanto sia comune effettuare la vaginectomia, l'uretroplastica e la falloplastica allo stesso tempo, l'uretroplastica e la vaginectomia non sono tecnicamente necessarie per costruire un pene. Però, essendo il tessuto vaginale tipicamente utilizzato per costruire una nuova uretra, alcuni chirurghi non effettueranno l'uretroplastica senza la vaginectomia.

**Operazione alla regione superiore** (modifiche al petto)
...
- Femminilizzanti:
  ...
  - Rimodellamento delle orbite oculari
  - Innalzamento delle sopracciglia
  - Correzione della stempiatura
  - Blefaroplastica (innalzamento delle occhiaie)
...
- Mascolinizzanti:
  ...
  - Incremento delle dimensioni della fronte
  - Incremento delle dimensioni della mandibola
